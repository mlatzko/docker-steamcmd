...
```bash
$ docker run -it wilkesystems/steamcmd:artful
```
...
# Auto Builds
New images are automatically built by each new library/ubuntu:artful push.


## Package: steamcmd
Package: [steamcmd](https://packages.ubuntu.com/de/artful/steamcmd)
