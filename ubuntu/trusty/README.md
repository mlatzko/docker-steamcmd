...
```bash
docker pull wilkesystems/steamcmd:trusty
```
...
# Auto Builds
New images are automatically built by each new library/ubuntu:trusty push.


## Package: steamcmd
Package: [steamcmd](https://packages.ubuntu.com/de/trusty/steamcmd)
